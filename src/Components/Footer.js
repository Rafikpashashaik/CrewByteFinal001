...
import NavLogo from "./crewbyteLogo.png";
const Footer = () => {
  return (
    <footer>
      <hr id="Line-break-Card"></hr> <br></br>
      <Row className="sections">
        ...
        >
          <img id="FooterLogo" src={NavLogo}></img>
        </Col>
...
{/* SOCIALIZE-WITH-US */}
            <div className="Icons-For-Footer  SOCIALIZE-WITH-US">
...
{/* LINKDI */}
            <a className="icon-link" href="https://www.linkedin.com/company/crew-byte-solutions-pvt-ltd/">
...
{/* INSTAGRAM */}
            <a className="icon-link" href="https://www.instagram.com/crewbytesolutions/">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <path d="M0 1H1269" stroke="url(#paint0_linear_291_196)" />
        <defs>
          <linearGradient
            id="paint0_linear_291_196"
            x1="1269"
            y1="1.00238"
            x2="3.52735e-07"
            y2="0.980001"
      ...
      >
        <path
          d="M0.5 1C20.5 1 201.5 1 289.5 1"
          stroke="url(#paint0_linear_295_323)"
        />
        <defs>
          <linearGradient
            id="paint0_linear_295_323"
            x1="-2.23865"
            y1="1.00004"
            x2="-2.23498"
            y2="-0.0667334"
      ...
      <div className="Copy-Rights">
        <span className="footer__copy">
          {" "}
          Copyright &#169; 2023 Crew Byte - IT/Software Services | Powered by
          Crew Byte - IT/Software Services
        </span>
      </div>
    </footer>
  );
